...
Tags: Kunena to bbPress, Kunena to bbPress migration, convert Kunena to bbPress, migrate Kunena to bbPress, bbPress, Kunena 
...
This is a plugin for an automated migration from Joomla Kunena to bbPress forum.

== Description ==

This is a plugin for an automated migration from Joomla Kunena to bbPress forum. With this instrument, the data conversion is fast and secure procedure that is suitable both for code-savvy users and non-techies.
...
= Pre-Migration Steps: =
* Backup your Joomla Kunena data
...
1. Go to Admin -> Plugins, find “CMS2CMS: Automated Kunena to bbPress Switch” and click Activate
...
Contact us at support@cms2cms.com.
